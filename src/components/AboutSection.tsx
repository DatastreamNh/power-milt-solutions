      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          {values.map((v, i) => (
            <div
              key={v.title}
              className="animate-on-scroll bg-background rounded-2xl p-8 hover:shadow-xl transition-all duration-500 group"
        ...
        <div className="animate-on-scroll bg-background rounded-2xl p-8 md:p-12">
